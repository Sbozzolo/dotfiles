...
* Lab
  #+BEGIN_SRC emacs-lisp
    (defun cancer ()
          "Spread cancer"
          (interactive)
          (start-process-shell-command "/home/sbozzolo/vm.sh" nil "/home/sbozzolo/vm.sh")
          (shell-command "sleep 2" nil "sleep 2")
          (start-process-shell-command "vncviewer localhost::5900" nil  "vncviewer localhost::5900")
          )
  #+END_SRC
** GNUs
  #+BEGIN_SRC emacs-lisp
...
** mu4e
   ...
   #+BEGIN_SRC emacs-lisp
     ...
     ;;         mu4e-sent-folder "/home/sbozzolo/.mail/sbozzolator/.sent"
     ;;         mu4e-sent-messages-behavior 'delete ;; Unsure how this should be configured
     ;;         mu4e-drafts-folder "/home/sbozzolo/.mail/sbozzolator/[Gmail].Drafts"
